...
" see completeopt=longest if trouble with starting
" dont't enable enter abort completion == default
" let g:SuperTabCrMapping = 0
" case insensitive match, default inherit from ignorecase
