" Colorscheme for zion.vim
" based upon zion from Jani Nurminen <slinky@iki.fi> http://kippura.org/zionpage/
" and BadWold by Steve Losh http://stevelosh.com/projects/badwolf/
...
if ! exists("g:zion_high_Contrast")
    let g:zion_high_Contrast = 0
endif

if ! exists("g:zion_transparent")
    let g:zion_transparent = 0
endif

if ! exists("g:zion_color_also_Ignore")
    let g:zion_color_also_Ignore = 0
endif

if ! exists("g:zion_alternate_Error")
    let g:zion_alternate_Error = 0
endif

if ! exists("g:zion_force_dark_Background")
    let g:zion_force_dark_Background = 0
endif

if ! exists("g:zion_alternate_Visual")
    let g:zion_alternate_Visual = 0
endif

if ! exists("g:zion_alternate_Include")
    let g:zion_alternate_Include = 0
endif

if ! exists("g:zion_disable_Label_underline")
    let g:zion_disable_Label_underline = 0
endif

if ! exists("g:zion_unified_CursorColumn")
    let g:zion_unified_CursorColumn = 0
endif

if ! exists("g:zion_old_Visual")
    let g:zion_old_Visual = 0
endif

if ! exists("g:zion_enable_TagHighlight")
    let g:zion_enable_TagHighlight = 0
endif
...
if exists("g:zion_high_Contrast") && g:zion_high_Contrast
    ...
    if exists("g:zion_unified_CursorColumn") && g:zion_unified_CursorColumn
    ...
    hi CursorLine    guibg=#434443                         ctermbg=240 cterm=none
...
if exists("g:zion_transparent") && g:zion_transparent
...
if exists("g:zion_old_Visual") && g:zion_old_Visual
    if exists("g:zion_alternate_Visual") && g:zion_alternate_Visual
...
if exists("g:zion_disable_Label_underline") && g:zion_disable_Label_underline
    hi Label    guifg=#dfcfaf                         ctermfg=187
else
    hi Label    guifg=#dfcfaf gui=underline           ctermfg=187 cterm=underline
endif

if exists("g:zion_color_also_Ignore") && g:zion_color_also_Ignore
...
"
" For now I mostly link to subset of zion colors, the linkage is based
" on appearance, not semantics. In later versions I might define more new colours.
"
" HELP NEEDED to make this work properly.

if exists("g:zion_enable_TagHighlight") && g:zion_enable_TagHighlight
